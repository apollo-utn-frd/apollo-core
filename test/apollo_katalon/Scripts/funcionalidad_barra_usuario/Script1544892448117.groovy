...
WebUI.click(findTestObject('Object Repository/Page_Apollo/li_Viajes creados'))

WebUI.click(findTestObject('Object Repository/Page_Apollo/li_Seguidos'))

WebUI.click(findTestObject('Object Repository/Page_Apollo/li_Seguidores'))
